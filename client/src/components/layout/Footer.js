            ...
            <Fragment>
                <div className="footerbgblack">
                    <div className="container">
                        <div className="row">
                            <div className="col-md-3 col-xs-6 footer-logo-area">
                            ...
                            <div className="col-md-3 col-xs-6 grey">
                            ...
                            <div className="col-md-3 col-xs-6 partnership-area">
                            ...
                            <div className="col-md-3 col-xs-6 social-area">
                                <div className="scont">
