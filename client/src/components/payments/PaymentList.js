    ...
    return (
        <div className="col-md-3">
                ...
                <div className="d-flex justify-content-between flight-payment-amount-content">
                    ...
                    <span className="flight-payment-amount-content-price">{parseFloat(selectedFlight.basePrice).toFixed(2)} {selectedFlight.currency}</span>
                </div>
                ...
                <div className="d-flex justify-content-between flight-payment-amount-content custom-border-bottom">
                    ...
                    <span className="flight-payment-amount-content-price">{parseFloat(selectedFlight.taxes).toFixed(2)} {selectedFlight.currency}</span>
                </div>

                <div className="d-flex justify-content-between flight-payment-amount-content">
                    <span className="flight-payment-amount-content-text font-weight-bold">Total Fare</span>
                    <span className="flight-payment-amount-content-price font-weight-bold">{parseFloat(selectedFlight.totalPrice).toFixed(2)} {selectedFlight.currency}</span>
                </div>
