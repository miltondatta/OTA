    ...
    return (
        <div className="col-md-3">
                ...
                <div className="d-flex justify-content-between flight-payment-amount-content">
                    ...
                    <span className="flight-payment-amount-content-price">{selectedFlight.basePrice}</span>
                </div>
                ...
                <div className="d-flex justify-content-between flight-payment-amount-content custom-border-bottom">
                    ...
                    <span className="flight-payment-amount-content-price">{selectedFlight.taxes}</span>
                </div>

                <div className="d-flex justify-content-between flight-payment-amount-content">
                    <span className="flight-payment-amount-content-text font-weight-bold">Total Fare</span>
                    <span className="flight-payment-amount-content-price font-weight-bold">{selectedFlight.totalPrice}</span>
                </div>
